...
PermissionsService.ɵfac = function PermissionsService_Factory(t) { return new (t || PermissionsService)(ɵngcc0.ɵɵinject(PERMISSIONS), ɵngcc0.ɵɵinject(PERMISSIONS_SUPPORT)); };
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PermissionsService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: Permissions, decorators: [{
                type: Inject,
                args: [PERMISSIONS]
            }] }, { type: Boolean, decorators: [{
                type: Inject,
                args: [PERMISSIONS_SUPPORT]
            }] }]; }, null); })();
if (false) {
    /**
     * @type {?}
